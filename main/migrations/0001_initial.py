    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('user', 'USER'), ('admin', 'ADMIN')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='restaurant_dish', to='main.restaurant')),
            ],
        ),
        migrations.CreateModel(
            name='Shift',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_dish', to='main.delivery')),
